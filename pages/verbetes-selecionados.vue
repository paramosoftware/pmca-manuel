        ...
        <main class="container mb-auto p-2 md:p-0 mx-auto">
            <div class="flex items-center justify-between">
                <div class="flex flex-col">
                    <h1 class="text-4xl font-semibold">Verbetes selecionados</h1>
                </div>
            </div>
            ...
            <div class="mt-6" id="selected-entries">
...
const fetchEntries = async (ids) => {
        const { data } = await useFetchWithBaseUrl('/api/entries/find-many-by-id', {
            method: 'POST',
            body: JSON.stringify({
                ids: ids
            })
